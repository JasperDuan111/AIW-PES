...
DIMENSIONS = [
    {
        ...
        'direction': 'negative',
        'questions': [
            'AI工具的快速更新让我感到跟不上节奏，心理上很有压力',
            '在使用AI工具时遇到技术问题，我会感到烦躁和无助',
            '学习使用新的AI工具占用了太多时间和精力，让我感到疲惫不堪',
            '我觉得自己被各类AI新技术占据了太多精力，难以平衡学习和生活'
        ]
    },
    {
        'id': 'competence_anxiety',
        'name': '能力焦虑与替代担忧',
        'direction': 'negative',
        'questions': [
            '我担心过度依赖AI会导致自己的独立思考能力下降',
            '看到别人熟练使用AI而我不太会时，我会感到焦虑',
            '我担心AI最终会取代我未来想从事的工作',
            'AI的发展让我对所学专业技能的价值感到担忧'
        ]
    },
    {
        'id': 'psychosocial_impact',
        'name': '心理社会影响',
        'direction': 'negative',
        'questions': [
            '关于AI的各种新闻和讨论增加了我的整体焦虑水平',
            '想到AI可能对我的未来造成影响时，我会感到情绪低落或无助',
            'AI对就业市场的冲击让我对未来职业发展感到迷茫',
            '对AI的担忧在一定程度上影响了我的睡眠或生活质量'
        ]
    },
    {
        'id': 'ai_efficacy',
        ...
        'direction': 'positive',
        'questions': [
            '我有信心能够学会并使用各种AI工具来辅助学习和工作',
            '即使AI技术在不断变化，我相信自己有能力适应和掌握',
            '我能主动寻找并选择适合自己的AI工具来提升效率',
            '面对AI带来的变化，我能积极调整心态并主动适应'
        ]
    },
    {
        ...
        'direction': 'positive',
        'questions': [
            '使用AI工具让我的学习和工作效率得到了显著提升',
            'AI帮我节省了大量时间和精力，让我感到更轻松',
            '借助AI，我能完成以前难以独立完成的学习或工作任务',
            '使用AI工具的整体体验顺畅自然，让我感到愉快'
        ]
    },
    {
        'id': 'composure_optimism',
        'name': '综合从容与乐观态度',
        'direction': 'positive',
        'questions': [
            '综合来看，AI让我对未来的学习和工作感到更加从容',
            '我对AI技术在工作和学习中的广泛应用持乐观态度',
            '总体而言，AI给我的学习和工作带来的积极影响大于消极影响',
            '与AI相关的体验中，我感受到的从容感多于焦虑感'
        ]
    }
]

...
### 题目结构
- **24题 · 6维度**，5点李克特量表（1=完全不同意 → 5=完全同意）
- **答题过程**：不显示维度标签，保护作答客观性
- **结果页**：展示完整的维度剖面分析和心理平衡指数

### 维度构成

| 类别 | 维度 | 题数 |
|------|------|:----:|
| 😰 负面（焦虑/压力） | 技术压力与适应困难 | 4题 |
| | 能力焦虑与替代担忧 | 4题 |
| | 心理社会影响 | 4题 |
| 😊 正面（轻松/从容） | AI效能感与掌控力 | 4题 |
| | 积极体验与效率提升 | 4题 |
| | 综合从容与乐观态度 | 4题 |

### 核心指标

- **焦虑指数** = 负面维度均分（1~5分，越高越焦虑）
- **从容指数** = 正面维度均分（1~5分，越高越从容）
- **心理平衡指数** = 从容指数 - 焦虑指数（-4 ~ +4）

  | 范围 | 类型 | 含义 |
  |:----:|------|------|
  | +1.0以上 | 从容主导型 | 积极体验为主 |
  | +0.3 ~ +1.0 | 轻微从容型 | 略偏积极体验 |
  | -0.3 ~ +0.3 | 基本平衡型 | 焦虑与从容相平衡 |
  | -1.0 ~ -0.3 | 轻微焦虑型 | 略偏负面情绪 |
  | -1.0以下 | 焦虑主导型 | 负面情绪为主 |
